...
#
# For guided setup, prefer:
#   python scripts/bootstrap_project.py --project PRJNA000000 --organism "Example organism" \
#     --scratch-root /scratch/my_user/rnaseq_project --conda-base /path/to/miniconda3

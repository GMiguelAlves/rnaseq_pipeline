#!/bin/bash
#SBATCH --job-name=quant_import
#SBATCH --output=logs/quantification/quant_import_%j.out
#SBATCH --error=logs/quantification/quant_import_%j.err
#SBATCH --ntasks=1
